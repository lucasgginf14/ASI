<template>
  <div class="container mt-5 mb-5">
    <h2 class="fw-bold mb-4">Mis Solicitudes Pendientes</h2>
    ...
    <div v-else class="text-center py-5 bg-light rounded border border-dashed">
      <p class="text-muted mb-3">No tienes solicitudes pendientes de aprobación.</p>
...
export default {
  ...
  computed: {
    requests() {
      // 🔍 FILTRO: Solo las que están esperando respuesta (PENDING)
      return this.bookings.filter((b) => b.state === "PENDING");
    }
  },
  async mounted() {
